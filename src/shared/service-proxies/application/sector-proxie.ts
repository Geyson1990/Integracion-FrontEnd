...
export class SectorServiceProxy {
    ...
    getAll(filter: string | undefined, sorting: string | undefined, maxResultCount: number | undefined, skipCount: number | undefined): Observable<PagedResultDtoOfSectorListDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_: any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<PagedResultDtoOfSectorListDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<PagedResultDtoOfSectorListDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<PagedResultDtoOfSectorListDto> {
        ...
        if (status === 200) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
                ...
                result200 = PagedResultDtoOfSectorListDto.fromJS(resultData200);
        ...
        return _observableOf<PagedResultDtoOfSectorListDto>(<any>null);
    }
    ...
    protected processGet(response: HttpResponseBase): Observable<SectorDto> {
        ...
        if (status === 200) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
                let result200: any = null;
                let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
                result200 = SectorDto.fromJS(resultData200);
                return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
    ...
    create(variable: SectorDto): Observable<SectorDto> {
    ...
    update(variable: SectorDto): Observable<void> {
...
export interface IPagedResultDtoOfSectorListDto {
    totalCount: number;
    items: SectorDto[] | undefined;
}

export class PagedResultDtoOfSectorListDto implements IPagedResultDtoOfSectorListDto {
    totalCount!: number;
    items!: SectorDto[] | undefined;

    constructor(data?: IPagedResultDtoOfSectorListDto) {
        if (data) {
    ...
    static fromJS(data: any): PagedResultDtoOfSectorListDto {
        data = typeof data === 'object' ? data : {};
        let result = new PagedResultDtoOfSectorListDto();
        result.init(data);
        return result;
    }
