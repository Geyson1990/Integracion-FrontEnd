...
import { DistrictDto } from './district-proxie';
...
export class ProvinceServiceProxy {
    ...
    getAll(filter: string | undefined, deparmentId: number, sorting: string | undefined, maxResultCount: number | undefined, skipCount: number | undefined): Observable<PagedResultDtoOfProvinceListDto> {
        let url_ = this.baseUrl + "/api/services/app/Ubigeo/GetAllProvinces?";
        if (filter !== undefined)
    ...
    protected processGetAll(response: HttpResponseBase): Observable<PagedResultDtoOfProvinceListDto> {
        ...
        if (status === 200) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
                ...
                result200 = PagedResultDtoOfProvinceListDto.fromJS(resultData200);
    ...
    get(id: number): Observable<ProvinceDto> {
        let url_ = this.baseUrl + "/api/services/app/Ubigeo/GetProvince?";
        if (id === null)
    ...
    create(item: ProvinceDto): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Ubigeo/CreateProvince";
    ...
    update(item: ProvinceDto): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Ubigeo/UpdateProvince";
    ...
    delete(id: number): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Ubigeo/DeleteProvince?";
        if (id === null)
            throw new Error("The parameter 'Id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
        ...
        if (data) {
            ...
            if (Array.isArray(data["districts"])) {
                ...
                for (let item of data["districts"])
                    this.districts!.push(DistrictDto.fromJS(item));
            }
        }
    }
