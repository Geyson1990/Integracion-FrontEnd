...
export class SideBarMenuComponent extends AppComponentBase implements OnInit, AfterViewInit {
    ...
    constructor(injector: Injector, private el: ElementRef, public permission: PermissionCheckerService, private _appNavigationService: AppNavigationService, @Inject(DOCUMENT) private document: Document, private render: Renderer2) {
        super(injector);
    }
