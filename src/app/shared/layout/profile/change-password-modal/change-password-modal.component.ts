...
import { ChangePasswordInput, codeText, PasswordComplexitySetting, ProfileServiceProxy } from '@shared/service-proxies/service-proxies';
...
export class ChangePasswordModalComponent extends AppComponentBase {
    ...
    save(): void {
        ...
        input.currentPassword = codeText(this.currentPassword);
        input.newPassword = codeText(this.password);
