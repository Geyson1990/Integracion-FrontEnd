...
import { CreateEditQuizStateComponent } from './state/create-edit-state/create-edit-state.component';
import { QuizResponseComponent } from './response/response.component';
import { QuizFormComponent } from './form/form.component';
import { QuizOptionComponent } from './form/form-option/form-option.component';
...
import { QuizDetailOptionComponent } from './detail/create-edit-detail/detail-option/detail-option.component';
...
@NgModule({
    ...
    declarations: [
        QuizStateComponent,
        CreateEditQuizStateComponent,
        QuizResponseComponent,
        QuizFormComponent,
        QuizOptionComponent,
        QuizDetailComponent,
        CreateEditDetailQuizComponent,
        QuizDetailOptionComponent
    ],
    providers: [
        TreeDragDropService,
