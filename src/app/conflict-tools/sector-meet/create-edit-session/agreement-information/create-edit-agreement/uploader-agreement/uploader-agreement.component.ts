...
@Component({
    selector: 'uploader-agreement',
    templateUrl: 'uploader-agreement.component.html',
    styleUrls: [
        'uploader-agreement.component.css'
    ]
})
export class UploaderAgreementComponent extends AppComponentBase {
