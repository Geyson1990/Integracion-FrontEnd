...
@Component({
  selector: 'create-select-column-directory-responsible',
  templateUrl: 'create-select-column-directory-responsible.component.html',
  styleUrls: [ 'create-select-column-directory-responsible.component.css']
})
export class CreateSelectColumnDirectoryResponsibleComponent extends AppComponentBase {
