...
import { DirectoryGovernmentSectorServiceProxy } from '@shared/service-proxies/application/directory-government-sector';
import { ModalDirective } from 'ngx-bootstrap/modal';

@Component({
  selector: 'create-select-column-directory-government-sector',
  templateUrl: 'create-select-column-directory-government-sector.component.html',
  styleUrls: ['create-select-column-directory-government-sector.component.css']
})
export class CreateSelectColumnDirectoryGovernmentSectorComponent extends AppComponentBase  {
