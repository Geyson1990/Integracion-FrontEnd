...
@Component({
  selector: 'create-select-column-directory-conflict-type',
  templateUrl: 'create-select-column-directory-conflict-type.component.html',
  styleUrls: ['create-select-column-directory-conflict-type.component.css']
})
export class CreateSelectColumnDirectoryConflictTypeComponent extends AppComponentBase {
