...
@Component({
  selector: 'create-select-column-directory-sector',
  templateUrl: 'create-select-column-directory-sector.component.html',
  styleUrls: ['create-select-column-directory-sector.component.css']
})
export class CreateSelectColumnDirectorySectorComponent extends AppComponentBase  {
