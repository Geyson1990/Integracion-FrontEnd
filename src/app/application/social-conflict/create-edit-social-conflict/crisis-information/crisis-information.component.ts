...
@Component({
    selector: 'crisis-information-social-conflict',
    templateUrl: 'crisis-information.component.html',
    styleUrls: [
        'crisis-information.component.css'
    ]
})
export class CrisisInformationSocialConflictComponent extends AppComponentBase implements OnInit {
