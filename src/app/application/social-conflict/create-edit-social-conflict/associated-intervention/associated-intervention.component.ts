...
@Component({
    selector: 'associated-intervention-social-conflict',
    templateUrl: 'associated-intervention.component.html',
    styleUrls: [
        'associated-intervention.component.css'
    ]
})
export class AssociatedInterventionSocialConflictComponent extends AppComponentBase implements OnInit {
