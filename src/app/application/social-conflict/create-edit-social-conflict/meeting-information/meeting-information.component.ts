...
@Component({
    selector: 'meeting-information-social-conflict',
    templateUrl: 'meeting-information.component.html',
    styleUrls: [
        'meeting-information.component.css'
    ]
})
export class MeetingInformationSocialConflictComponent extends AppComponentBase implements OnInit {
