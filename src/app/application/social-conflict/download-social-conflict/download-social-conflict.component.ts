...
@Component({
    selector: 'download-social-conflict',
    templateUrl: 'download-social-conflict.component.html',
    styleUrls: [
        'download-social-conflict.component.css'
    ]
})

export class DownloadSocialConflictComponent extends AppComponentBase {
