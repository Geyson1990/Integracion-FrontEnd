...
import { DashboardSpinnerComponent } from './dashboard-shared/spinner/dashboard.spinner.component';
...
@NgModule({
    ...
    declarations: [
        ...
        DashboardSocialConflictComponent,
        DashboardSocialConflictAlertComponent,
        DashboardSocialConflictSensibleComponent
    ],
    providers: [
        DashboardService,
        TreeDragDropService,
